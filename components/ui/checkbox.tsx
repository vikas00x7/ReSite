      ...
      >
        <button
          ...
          className={cn(
            ...
            checked && "bg-gradient-to-r from-indigo-500 to-fuchsia-500 border-transparent [box-shadow:inset_0px_-1px_0px_0px_rgba(10,10,10,0.2),_0px_1px_3px_0px_rgba(109,_40,_217,_30%)]",
